...
<div id="wrapper" class="wrapper">
        ...
        <div id="container" class="container">
            ...
            <div id="searching" style="<?PHP if (empty($_REQUEST['character'])) echo "margin-top: 220px;" ?>">
				...
				if (empty($_REQUEST['character'])) {
					echo "<div style='text-align:center;margin:20px;padding:20px;' class='general-bg'>是否在檢索“粵用漢字”？來試試<a href='https://jyutjam.org/jyutdict-android/' target='_blank'>泛粵典安卓版</a>！</div>";
				} else {
