  ...
  <div class="container mx-auto px-4 pt-20 pb-12 flex flex-col items-center">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 w-full max-w-2xl">
        ...
        <div class="flex justify-center gap-1 font-mono text-xl h-10">
             <div class="w-10 flex items-center justify-center rounded bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-300">{{ parsedComponents.in }}</div>
             <template v-for="(v, i) in parsedComponents.nu" :key="i">
                 <div class="w-10 flex items-center justify-center rounded bg-orange-100 dark:bg-orange-900/50 text-orange-700 dark:text-orange-300">{{ v }}</div>
             </template>
             <div class="w-10 flex items-center justify-center rounded bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300">{{ parsedComponents.co }}</div>
             <div class="w-10 flex items-center justify-center rounded bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300">{{ parsedComponents.to }}</div>
        </div>
    </div>
